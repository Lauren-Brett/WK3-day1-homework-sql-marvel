...
-- INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2019, '18.50');
-- SELECT title FROM movies;

-- SELECT * FROM movies;
-- SELECT * FROM movies WHERE id = 3;
UPDATE movies SET (title, show_time) = ('Iron Man 3', '19:25') WHERE title = 'Iron Man 3';
SELECT * FROM movies;
